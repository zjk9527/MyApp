...
public class PermissionHelper {
	...
	private final static int ACCESS_FINE_LOCATION_CODE=104;
	/**
	...
	private PermissionModel[] mPermissionModels = new PermissionModel[] {
			...
			new PermissionModel("定位",Manifest.permission.ACCESS_COARSE_LOCATION,"需要您允许我们使用定位权限",ACCESS_COARSE_LOCATION_CODE),
			new PermissionModel("位置",Manifest.permission.ACCESS_FINE_LOCATION,"请允许我们使用您先在的位置",ACCESS_FINE_LOCATION_CODE)
